...
import br.com.matheus.gestao_vagas.modules.company.useCases.ListAllJobsByCompanyUseCase;
...
public class JobController {
        ...
        public ResponseEntity create(@Valid @RequestBody CreatedJobDTO createdJobDTO, HttpServletRequest request) {
                ...
                try {
                        ...
                        var result = this.createTrabalhoCasosUsar.execute(jobEntity);
